...
public class Login {
    ...
    @Generated
    public Login(Long id, String username, String userpasswd, String movie_preference, String music_preference, String user_photo_url, String nickname, String sex, Integer age) {
        this.id = id;
