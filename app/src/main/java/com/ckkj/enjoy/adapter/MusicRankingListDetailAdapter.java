...
public class MusicRankingListDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<RankingListDetail.SongListBean> list;
    private static final int TYPE_HEAD = 0;
    private static final int TYPE_LIST = 1;
    private onItemClickListener mOnItemClickListener;
    private onPlayAllClickListener mOnPlayAllClickListener;

    public MusicRankingListDetailAdapter(Context context, List<RankingListDetail.SongListBean> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof HeaderViewHolder){
            ...
            final RankingListDetail.SongListBean detail = list.get(position - 1);
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            ...
            mRlPlayAll.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mOnPlayAllClickListener.onItemClick();
                }
            });
